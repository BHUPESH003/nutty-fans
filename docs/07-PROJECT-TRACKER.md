...
| **User Service** | /users/*, /profile/* | P0 | 2-3 |
| **Creator Service** | /creators/*, /kyc/* | P0 | 3-4 |
| **Content Service** | /posts/*, /media/* | P0 | 4-5 |
| **Payment Service** | /subscriptions/*, /wallet/* | P0 | 5-6 |
| **Messaging Service** | /conversations/*, /messages/* | P0 | 6-7 |
| **Notification Service** | /notifications/* | P0 | 7-8 |
| **Search Service** | /search/*, /explore/* | P0 | 8-9 |

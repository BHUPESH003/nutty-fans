...
-- CreateEnum
CREATE TYPE "AgeVerificationStatus" AS ENUM ('pending', 'passed', 'failed', 'needs_review');
...
-- CreateIndex
CREATE INDEX "age_verifications_provider_session_id_idx" ON "age_verifications"("provider_session_id");

-- CreateIndex
CREATE INDEX "age_verifications_status_idx" ON "age_verifications"("status");

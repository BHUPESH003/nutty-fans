  ...
  return (
    <div className="flex min-h-screen flex-col lg:h-screen lg:overflow-hidden">
      ...
      <div className="grid flex-1 grid-cols-1 lg:min-h-0 lg:grid-cols-2">
        ...
        <section
          className={cn(
            'relative flex min-h-[40vh] flex-col justify-between overflow-hidden bg-[#121212] px-6 pb-10 pt-10',
            'lg:h-full lg:min-h-0 lg:px-12 lg:pb-12 lg:pt-12'
          )}
        >
          ...
          <div className="relative z-10 flex flex-1 flex-col justify-between gap-10">
            ...
            {/* Stats — desktop only */}
            <div className="hidden grid-cols-3 divide-x divide-white/15 border-t border-white/10 pt-8 lg:grid">
        ...
        <section
          className={cn(
            'relative z-20 flex flex-col justify-center bg-white px-6 py-10',
            '-mt-10 rounded-t-3xl shadow-[0_-12px_48px_rgba(0,0,0,0.12)] lg:mt-0 lg:rounded-none lg:px-12 lg:py-16 lg:shadow-none'
          )}
        >
          <div className="mx-auto w-full max-w-md">
            <div className="hidden justify-center lg:flex">
              <div className="flex h-20 w-20 items-center justify-center rounded-full bg-primary-fixed text-2xl font-extrabold text-primary shadow-md">
                18+
              </div>
            </div>

            <h1 className="mt-0 text-center font-headline text-3xl font-bold text-on-surface lg:mt-8">
              Adults only
            </h1>
            <p className="mt-2 text-center text-base font-medium text-on-surface-variant lg:text-lg">
              You must be 18+ to enter.
            </p>

            <p className="mt-6 text-center text-sm leading-relaxed text-on-surface-variant">
            ...
            <div className="mt-6 rounded-xl bg-surface-container-low px-4 py-3 lg:hidden">
            ...
            <div className="mt-8 flex flex-col gap-3">
              ...
              <Button
                type="button"
                variant="outline"
                className="h-12 w-full rounded-full border-surface-container-high bg-white text-on-surface hover:bg-surface-container-low"
                onClick={handleExit}
              >
                I am under 18 — Exit
              </Button>
            ...
            <p className="mt-6 text-center text-[11px] leading-relaxed text-on-surface-variant">
            ...
            <div className="mt-8 flex items-start justify-center gap-8 sm:gap-12">
      ...
      <footer className="border-t border-surface-container-high bg-surface-container-low px-4 py-6">

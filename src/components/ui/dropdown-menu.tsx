...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <span className="material-symbols-outlined ml-auto text-[18px] text-muted-foreground">
      chevron_right
    </span>
  </DropdownMenuPrimitive.SubTrigger>
));
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'data-[state=open]:animate-in data-[state=closed]:animate-out z-50 min-w-[8rem] overflow-hidden rounded-md border border-border bg-background p-1 text-foreground shadow-popover',
      className
    )}
    {...props}
  />

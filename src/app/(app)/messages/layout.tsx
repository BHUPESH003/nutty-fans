...
export default function MessagesLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      <div className="flex h-screen min-h-0 overflow-hidden bg-background md:h-full md:rounded-[28px] md:border md:border-border md:bg-surface-container-lowest md:shadow-card">
        <div
          className={cn(
